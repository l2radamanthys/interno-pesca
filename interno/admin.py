...
from interno.admin_class.especies_resultados import EspecieResultado, EspecieResultadoAdmin
...
from interno.admin_class.inscripciones_torneo import InscripcionTorneo, InscripcionTorneoAdmin
