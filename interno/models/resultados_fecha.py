...
class ResultadoFecha(models.Model):
    participante = models.ForeignKey("Participante", related_name="resultados_fecha", on_delete=models.CASCADE, default=None, blank=True, null=True)
    fecha_de_pesca = models.ForeignKey("FechaDePesca", related_name="resultados_fecha", on_delete=models.CASCADE, default=None, blank=True, null=True)
